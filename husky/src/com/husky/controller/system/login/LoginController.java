package com.husky.controller.system.login;
...
import com.husky.entity.system.Menu;
import com.husky.entity.system.Role;
import com.husky.entity.system.User;
import com.husky.service.system.menu.MenuService;
import com.husky.service.system.role.RoleService;
import com.husky.service.system.user.UserService;
import com.husky.util.AppUtil;
import com.husky.util.Const;
import com.husky.util.DateUtil;
import com.husky.util.PageData;
import com.husky.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq313596790husky", "").replaceAll("QQ978336446husky", "").split(",husky,");
