...
<html lang="en">
	<head>
		...
		.commitbox_top{width:700px; height:250px; margin-bottom:10px; padding-top:10px; background:#FFF; border-radius:5px; box-shadow:1px 1px 3px #e8e8e8;}
		        	...
		        	<table>
		        		<tr>
		        			...
		        			<td style="padding-bottom: 6px;">
								...
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio3" onclick="setType('Double');" type="radio" value="icon-edit"><span class="lbl">Double</span></label>
	...
	<form action="createCode/proCode.do" name="Form" id="Form" method="post">
		...
		<table style="margin-top: 10px;" border="0">
			<tr>
				...
				<td>&nbsp;&nbsp;例如:com.husky.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;红色部分</td>
			</tr>
		</table>
		<table border="0">
			<tr>
