			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">发货截止时间</th>
						<th class="center">订单补款金额</th>
						<th class="center">网关手续费</th>
						<th class="center">产品总计</th>
						<th class="center">订单备注</th>
						<th class="center">订单状态</th>
						<th class="center">订单总额</th>
						<th class="center">付款时间</th>
						<th class="center">订单降价金额</th>
						<th class="center">订单退款金额</th>
						<th class="center">订单涨价金额</th>
						<th class="center">seller优惠券</th>
						<th class="center">运费</th>
						<th class="center">买家选择物流方式</th>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										<td>${var.ORDERNO}</td>
										<td>${var.ACTUALPRICE}</td>
										<td>${var.COMMISSIONAMOUNT}</td>
										<td>${var.DELIVERYDATE}</td>
										<td>${var.DELIVERYDEADLINE}</td>
										<td>${var.FILLINGMONEY}</td>
										<td>${var.GATEWAYFEE}</td>
										<td>${var.ITEMTOTALPRICE}</td>
										<td>${var.ORDERREMARK}</td>
										<td>${var.ORDERSTATUS}</td>
										<td>${var.ORDERTOTALPRICE}</td>
										<td>${var.PAYDATE}</td>
										<td>${var.REDUCEPRICE}</td>
										<td>${var.REFUNDMONEY}</td>
										<td>${var.RISEPRICE}</td>
										<td>${var.SELLERCOUPONPRICE}</td>
										<td>${var.SHIPPINGCOST}</td>
										<td>${var.SHIPPINGTYPE}</td>
