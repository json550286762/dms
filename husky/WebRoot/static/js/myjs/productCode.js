 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',husky,' + dtype + ',husky,' + dbz + ',husky,' + isQian + ',husky,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',husky,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',husky,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',husky,')[0];
			if(array0 == value){
				return false;
			}
		}
